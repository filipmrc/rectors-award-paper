...
Ovakav sustav ostvarujemo snimanjem pokreta ruke korisnika pomoću RGB-Dubinske kamere, koja uz sve funkcije standardne kamere vraća informaciju o udaljenosti objekata u kadru.
...
Problem detekcije stanja ljudske ruke obrađen je u poglavlju "Detekcija", gdje dvije izložene metode uspoređujemo na bazi mogućnosti i performansi.
...
Sustav je dizajniran da bude univerzalan s obzirom na manipulator i detekcijski uređaj, ali pri svim testiranjima koristili smo Kinova Jaco robotsku ruku i Microsoft Kinect RGB-Dubinsku kameru.
...
Senzori pozicije služe za bilježenje zakreta svakog pojedinačnog zgloba manipulatora, a diferenciranjem zakreta dobivamo informaciju o brzini okretanja.
...
Kako bi se postiglo simuliranje dinamike robota korsitimo DART\footnote{\textbf{DART} (engl . Dynamic Animation and Robotics Toolkit) - \texttt{www.dartsim.github.io}} , jednu od nekoliko biblioteka ovog tipa koje Gazebo podržava.
...
Unatoč tome što većina komercijalnih manipulatora dolazi sa već izvedenim naprednim kinematičkim funkcijama, odlučeno je da radi kompletnosti izvedbe moramo predvidjeti i slučaj kada su dostupne samo naredbe pomicanja zglobova.
