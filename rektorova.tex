...
\caption{Prikaz zadane putanje i njene izvedbe simuliranom Jaco robotskom rukom unutar Gazebo okruženja. \textbf{Lijevo}: prikaz u xz-ravnini \textbf{Desno}: prikaz u yz-ravnini} \label{krug_1}
\end{figure}
...
\caption{Prikaz zadane putanje i njene izvedbe simuliranom Jaco robotskom rukom unutar Gazebo okruženja. \textbf{Lijevo}: prikaz u xz-ravnini \textbf{Desno}: prikaz u yz-ravnini} \label{krug_2}
\end{figure}
...
Iz ovih rezultata možemo zaključiti kako je pri translacijskom gibanju po neprekinutoj krivulji kinematičko rješenje zadovoljavajuće. 
Također je potrebno napomenuti kako postoje točke u kojima i programska izvedba postaje numerički nestabilna te se u tim slučajevima karakteristike ponešto kvare.
