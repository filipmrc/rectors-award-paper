...
\begin{algorithmic}
\STATE{\textbf{Ulaz:} P -- odmak dlana od početne pozicije \\ \quad R -- diskretna orijentacija \\ M -- početni vektor konfiguracije manipulatora \\ T -- trenutni vektor konfiguracije manipulatora.}
