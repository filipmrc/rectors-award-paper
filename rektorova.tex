...
\title{Intuitivni sustav teleoperacije robotskog manipulatora korištenjem dubinske kamere}
...
Problem detekcije položaja ruke relativno uspješno je riješen i kod klasičnih slika (npr. //todo 3 citata), ali je taj pristup obilježen prevelikom ovisnošću o svjetlosnim parametrima slike te potrebom za većim računalnim resursima. Takvi zahtjevi uvelike otežavaju detekciju u stvarnom vremenu na osobnom računalu.
...
Vrsta skupa & Točnost otvorenosti & Točnost orijentacije & Ukupna točnost \\ \hline
    ...
    Skup za validaciju &$96.4\%$&$93.7\%$&$91.1\%$\\
    Skup za ispitivanje & $96.7\%$&$93.6\%$&$91.2\%$\\ \hline
    \end{tabular}
    \caption{Prikaz tehničkih specifikacija Jaco robotske ruke} \label{bla}
\end{table}
