...
Programskom izvedba pomoću KDL biblioteka oslanja se na poboljšanu varijantu metode \ref{jacob3} zvanu metoda prigušenih najmanjih kvadrata (\textit{engl. damped least squares}).
...
\label{eo}
\end{equation}
Koristimo izraz \ref{eo} definiran u (RMPC-139), koji je pogodan za kinematičke lance koji ne posjeduju sferne zglobove.
...
\subsubsection{Provjera sustava}\label{provjera}
...
Iz slike \ref{rot2m} vidimo kako je ostvaren drastično bolji odziv. 
