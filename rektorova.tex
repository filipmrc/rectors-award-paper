...
Rezultati prve ispitane situacije vidljivi su na grafovima \ref{fig:jacok1} i \ref{fig:jacok2}.
Uočljivo je kako kretanja prikazana na ove dvije skupine grafova indiciraju različite karaktere kretanja ruke korisnika. 
...
Pri tome su zadatke morali izvršiti na dva načina. Pomoću igraće palice koja je sastavni dio opreme koja dolazi uz robotsku ruku te pomoću našeg sustava.

Mjerena je brzina izvođenja zadataka prilikom prvog susreta s robotskom rukom te nakon 15 minuta upoznavanja s načinima upravljanja. Htjelo se usporediti vrijeme potrebno za savladavanje oba sustava upravljanja. Prilikom mjerenja od 16 kandidata odbačeni su rezultati najboljih te najgorih, a od ostatka je izračunata aritmetička sredina.
...
\begin{table}[h!]
    ...
    \begin{tabular}{ | l | l | l |}
    \hline
     & Igraća palica&Razvijeni sustav\\ \hline
...
Ispitali smo i subjektivno mišljenje studenata te je traženo da subjektivno ocjene iskustvo upravljanja na skali od 1 - 10 pri čemu su u obzir morali uzeti: jednostavnost korištenja, spretnost u izvođenju pokreta, te opći osjećaj zadovoljstva tokom izvođenja zadatka.
